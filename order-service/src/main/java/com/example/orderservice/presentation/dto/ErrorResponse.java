...
public class ErrorResponse {
    ...
    public ErrorResponse(String error, String message, Instant timestamp) {
        this(error, message, timestamp, null, null);
    }
    
    public ErrorResponse(String error, String message, Instant timestamp, String path) {
        this(error, message, timestamp, path, null);
    }
    
    public ErrorResponse(String error, String message, Instant timestamp, String path, Map<String, String> details) {
        this.error = error;
